...
#title
heading_label = Label(root, text="WELCOME TO MUSIC PLAYER...",bg='LightBlue', font=("Helvetica", 16, "bold"))
heading_label.pack(pady=5)  # Adjust padding as needed

# All the frames
song_frame = LabelFrame(root, text='Current Song Status', bg='LightBlue', width=500, height=80)
song_frame.place(x=5, y=60)

button_frame = LabelFrame(root, text='Control Buttons', bg='white', width=500, height=120)
button_frame.place(x=5,y=150)

listbox_frame = LabelFrame(root, text='Playlist', bg='RoyalBlue')
listbox_frame.place(x=510, y=60, height=210, width=470)

# All StringVar variables
current_song = StringVar(root, value='<   No Song selected.......>')

song_status = StringVar(root, value='<    No Song Available.............>')
...
song_lbl = Label(song_frame, textvariable=current_song, bg='Goldenrod', font=("Times", 12), width=30)
song_lbl.place(x=150, y=20)

# Buttons in the main screen
pause_btn = Button(button_frame, text='Pause', bg='RoyalBlue', font=("Georgia", 13), width=7,
...
resume_btn = Button(button_frame, text='Resume', bg='RoyalBlue', font=("Georgia", 13), width=7,
                    command=lambda: resume_song(song_status))
resume_btn.place(x=285, y=10)

load_btn = Button(button_frame, text='Load Directory', bg='orange', font=("Georgia", 13), width=45,
